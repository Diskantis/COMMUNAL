...
class UiWinPayment(object):
    def setupUi_PAY(self, WinPayment):
        ...
        self.WinPayment.setGeometry(QtCore.QRect(560+1920-400, 300, 800, 400))
        ...
        self.WinPayment.setTabOrder(self.btn_Right_PAY, self.pay_power.line_edit_tariff)
        ...
        self.WinPayment.setTabOrder(self.pay_gaz.line_edit_tariff, self.pay_apartment.line_edit_sum)
